...
executaInstr valuatie (Bucla e p1) = case (evalp e valuatie) of
                                        Nothing -> Nothing
                                        Just 0 -> Just valuatie
                                        otherwise -> case executaProgram valuatie p1 of
                                                        Nothing -> Nothing
                                                        Just valuatie' -> executaInstr valuatie' (Bucla e p1)
executaInstr valuatie (For i1 e i2 p1) = case executaInstr valuatie i1 of
                                            Nothing -> Nothing
                                            Just valuatie' -> executaInstr valuatie' (Bucla e (p1 ++ [i2]))
...
prog3 :: Program
prog3 = [Atrib "s" (Numar 0),
        For (Atrib "n" (Numar 10)) (Var "n") (Atrib "n" (Diferenta (Var "n") (Numar 1))) [
            Atrib "s" (Suma (Var "s") (Var "n"))
        ],
        Atrib "result" (Var "s")]
