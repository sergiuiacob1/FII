...
--executaInstr (valuatie) (Atrib string exp) = \varName -> valuatie varName where valuatie string = evalp exp valuatie
executaInstr val (Atrib var exp) = update val var (evalp exp val)
